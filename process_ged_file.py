        ...
        if c1 == "0":
            if have_record:
                if individual_id != 0:
                    ...
                    if name != "": name = name + " "
                    name = name + surname
                    ind.add_individual("N", individual_id, surname, forename, name, birth_date, birth_place, \
                    ...
                    have_record = False
                if family_id != 0:
                    fam.add_family("N", family_id, husband_id, wife_id, marriage_date, marriage_place)
                    have_record = False
            record_type = s[-4:]
